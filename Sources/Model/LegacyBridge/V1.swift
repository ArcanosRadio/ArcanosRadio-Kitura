...
struct PlaylistV1: CustomEncoder {
    ...
    func encode(entity: Playlist, encoder: Encoder) throws {
...
struct SongV1: CustomEncoder {
    ...
    func encode(entity: Song, encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
...
struct ArtistV1: CustomEncoder {
    ...
    func encode(entity: Artist, encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
...
struct FileV1: CustomEncoder {
    ...
    func encode(entity: String, encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
