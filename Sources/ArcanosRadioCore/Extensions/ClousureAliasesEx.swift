...
// public typealias ResultClosureEx = (RequestError?) -> Void
...
public typealias CodableIdentifierClosureEx<I: Codable, Id: Identifier, O: Codable> = (I, @escaping IdentifierCodableResultClosureEx<Id, O>) -> Void
// public typealias NonCodableClosureEx = (@escaping ResultClosure) -> Void
// public typealias IdentifierNonCodableClosureEx<Id: Identifier> = (Id, @escaping ResultClosure) -> Void
